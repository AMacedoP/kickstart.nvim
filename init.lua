    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Adds rounded corners to `vim.lsp.buf.hover()` and
          -- `vim.lsp.buf.signature_help()`. We need to rewrite the builtin keymaps
          -- for K and <C-K> because there's no way to configure them like
          -- `vim.diagnostics`
          map('K', function()
            vim.lsp.buf.hover({ border = 'rounded' })
          end, 'Show documentation', 'n')
          map('<C-K>', function()
